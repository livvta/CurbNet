...
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple torch==1.7.1+cu110 torchvision==0.8.2+cu110 torchaudio==0.7.2 -f https://download.pytorch.org/whl/torch_stable.html
RUN pip3 install pyyaml==5.4.1
RUN pip3 install cython==0.29.24
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple nuscenes-devkit==1.1.6
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple numba==0.53.1
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple strictyaml==1.4.4

# Torch scatter
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple --no-index torch-scatter -f https://pytorch-geometric.com/whl/torch-1.6.0+cu102.html
...
WORKDIR /spconv/dist
RUN pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple *.whl
